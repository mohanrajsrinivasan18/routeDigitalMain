...
import avatar12 from '../../images/avatar/avatar_12.webp'
                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="it_solution_hero_content" style={{ backgroundImage: `url(${Bg1})` }}>
                            <div className="heading_focus_text mb-0 d-inline-flex align-items-center">👋 Hi We <span className="badge bg-secondary text-white">Are Route Digital</span></div>
                            <h1>
                               Scale Your Business with Creative Digital Solutions
                            </h1>
                            <p>
                               In the modern business world, smart, affordable, and powerful IT solutions are key to staying ahead of the competition.
                            </p>
                                ...
                                <li>
                                    <div className="review_short_info">
                                        <div className="d-flex">
                                            <img src={icon} alt="Route Digital - Trustpilot Review" />
                                            <span>4.8</span>
                                        </div>
                                        <div className="review_counter">From <b>20+</b> reviews</div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="col-lg-5">
                        <ul className="it_solution_hero_images unordered_list">
                            <li>
                                <img src={heroImg} alt="Route Digital - IT Solution - Hero" />
                            </li>
                            <li>
                                <div className="worldwide_clients">
                                    <p>
                                        A New Age Software Company for Modern Challenges
                                    </p>
                                    <ul className="avatar_group unordered_list">
                                        <li>
                                            <img src={avatar1} alt="Route Digital - Avatar" />
                                        </li>
                                        <li>
                                            <img src={avatar2} alt="Route Digital - Avatar" />
                                        </li>
                                        <li>
                                            <img src={avatar3} alt="Route Digital - Avatar" />
                                        </li>
                                        <li>
                                           <img src={avatar12} alt="Route Digital - Avatar" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
