    ...
    return (
        <section className="service_section pt-175 pb-80 bg-light section_decoration xb-hidden">
                        ...
                        <div className="col-lg-4" key={srv}>
                            <div className="service_block_2">
                                <div className="service_icon">
                                    <img src={service.sImg} alt="Route Digital - Service icon" />
                                </div>
            ...
            <div className="decoration_item shape_image_2">
                <img src={shape2} alt="Route Digital Shape"/>
            </div>
            <div className="decoration_item shape_image_3">
                <img src={shape3} alt="Route Digital Shape"/>
            </div>
            <div className="decoration_item shape_image_4">
                <img src={shape4} alt="Route Digital Shape Angle"/>
            </div>
            <div className="decoration_item shape_image_5">
                <img src={shape5} alt="Route Digital Shape Angle"/>
            </div>
        </section>
    );
}
