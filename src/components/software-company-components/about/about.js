  ...
  return (
    <section className="about_and_case_section section_space section_decoration bg-dark" style={{ backgroundImage: `url(${Bg})` }}>
          ...
          <div className="col-lg-7 order-lg-last">
            <div className="about_image_2">
              <div className="image_wrap">
                <img src={about1} alt="Route Digital - About" />
              </div>
            ...
            <div className="about_content">
              <div className="heading_block mb-0 text-white">
                ...
                <h2 className="heading_text">
                  Route Digital <mark>Mission & Goal</mark>
                </h2>
                <p className="heading_description mb-0">
                  At Route Digital, our mission is to empower businesses through innovative software solutions that streamline operations, foster growth, and drive success. With a commitment to excellence and customer satisfaction we strive.
                </p>
              </div>
            </div>
          </div>
            ...
            {Project.slice(6, 9).map((project, prj) => (
              <div className="case_study_block" key={prj}>
                <div className="case_study_image">
                  <img src={project.pImg} alt="Route Digital - Cases" />
                </div>
      ...
      <div className="decoration_item shape_image_1">
        <img src={shape1} alt="Route Digital Shape" />
      </div>
    </section>
  )
}
