...
const testimonial = [
    {
        id: '01',
        Des: "Working with Route Digital was a game-changer for our business. Their  tailored solutions and dedicated support propelled us to new heights",
        Title: 'Sarah Johnson',
                            ...
                            <div className="about_image_3">
                                ...
                                <div className="funfact_block capsule_layout">
                                    <div className="funfact_icon">
                                        <img src={abImg2} alt="Route Digital - SVG Icon Wallet" />
                                    </div>
