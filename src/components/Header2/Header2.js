                        ...
                        <div className="col-xl-3 col-lg-2 col-5">
                            <div className="site_logo">
                                <Link onClick={ClickHandler} className="site_link" to="/">
                                    <img src={logo} alt="Site Logo – Route Digital – IT Solutions & Technology, Business Consulting, Software Company Site Template" />
                                    <img src={logo2} alt="Site Logo – Route Digital – IT Solutions & Technology, Business Consulting, Software Company Site Template" />
                                </Link>
                            </div>
                        </div>
                                                                    ...
                                                                    <div className="col-lg-3 col-md-6">
                                                                        <Link onClick={ClickHandler} className="iconbox_block_2" to="/about">
                                                                            ...
                                                                            <span className="description mb-0">
                                                                                Learn more about Route Digital
                                                                            </span>
                                                                        </Link>
                                                                    </div>
                                                                    <div className="col-lg-3 col-md-6">
                                                            ...
                                                            <div className="site_author bg-primary">
                                                                <div className="author_box">
                                                                    ...
                                                                    <div className="author_box_content">
                                                                        ...
                                                                        <span className="author_designation text-white">CEO At Route Digital</span>
                                                                    </div>
                                                                ...
                                                                <p className="mb-0 text-white">
                                                                    As a CEO at Route Digital  I have been voice crying in the wilderness,  trying to make requirements clear, use every minute to deliver the  result, and not reinvent the wheel. Here at Route Digital, I made that possible  for the clients.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
