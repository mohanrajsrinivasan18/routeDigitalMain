                        ...
                        <div className="row justify-content-lg-between">
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="footer_widget pe-md-3">
                                    ...
                                    <p>
                                        Sign up to Route Digital weekly newsletter to get the latest updates.
                                    </p>
            ...
            <div className="footer_bottom">
                <div className="container d-md-flex align-items-md-center justify-content-md-between">
                    <p className="copyright_text m-0">
                        Copyright © 2025 Route Digital, All rights reserved.
                    </p>
                    {/* <p className="copyright_text m-0">
                        Developed by <Link onClick={ClickHandler} to="/">Route Digital</Link>
                    </p> */}
                </div>
            </div>
        </footer>
